            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  required
                  className="h-11 bg-white border-black/10 text-black placeholder:text-black/40 focus:border-[#EFA07F] focus:ring-2 focus:ring-[#EFA07F]/20 transition-all rounded-lg pr-10"
                />
                <button
                  type="button"
